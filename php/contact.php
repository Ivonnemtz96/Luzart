...
if (!validarVariable($nombre) || !validarVariable($mail) || !validarVariable($msj)){
  mandarError("1");
}

$correo_nuevo = new Correo("contacto@distribuidoraluzart.com", $nombre.' ha enviado un nuevo mensaje');
$correo_nuevo->agregarCampos("Nombre: ", $nombre);
$correo_nuevo->agregarCampos("Email: ", $mail);
$correo_nuevo->agregarCampos("Solicitudes especiales: ", $msj);
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  ...
                  <tr>
                    <td class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      Powered by <a href="#" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;"><strong>Prueba Captcha</strong>.</a>
                    </td>
                  </tr>
                </table>
              </div>
